...
import (
	...
	"github.com/zhouhp1295/g3-game/modules/system/migrations"
	"github.com/zhouhp1295/g3-game/modules/system/model"
	_ "github.com/zhouhp1295/g3-game/modules/system/routers"
...
func SyncTables() {
	...
	if err != nil {
		g3.Fatal("AutoMigrate System Database", zap.Error(err))
	}
}
